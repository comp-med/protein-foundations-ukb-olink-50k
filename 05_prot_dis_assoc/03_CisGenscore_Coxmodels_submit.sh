...
#SBATCH --job-name=CisGenscore_Cox_Protvar
...
R_SCRIPT='/sc-projects/sc-proj-computational-medicine/people/Kamil/projects/03_UKB_Protein_Variance/01_Cox_prediction/scripts/03_CisGenscore_Coxmodels.R'
