...
#SBATCH --job-name=Top10_Adj_Cox_Protvar
...
R_SCRIPT='/sc-projects/sc-proj-computational-medicine/people/Kamil/projects/03_UKB_Protein_Variance/01_Cox_prediction/scripts/02_Top10_Adjusted_Coxmodels.R'
